...
type TenantToolConfig struct {
	ID       uint64 `gorm:"primaryKey"`
	TenantID uint64 `gorm:"uniqueIndex:idx_tenant_tool;not null"`
	ToolName string `gorm:"size:128;not null;uniqueIndex:idx_tenant_tool;comment:工具标识，knowledge_retrieve"`
